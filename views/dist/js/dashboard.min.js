...
angular.module("RDash").controller('editSubproyectosCtrl', function($scope, /*$mdDialog, $mdEditDialog,*/ $location, Proyecto, Subproyecto, Departamento) {
    ...
    function refreshSb() {
        ...
        console.log('idSubProyActual= '+idSubProyActual);
