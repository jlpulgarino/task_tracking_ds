...
angular.module('RDash').service('Tarea', function($rootScope, Http, EventHandler) {
    ...
    self.getEstimaciones = function(tareaId, semana){
        return Http.get('tareas/'+tareaId+'/estimaciones/'+semana);
    };
...
angular.module('RDash').service('Reporte', function($rootScope, Http, EventHandler) {
    ...
    self.getAll = function(dptoId, semIni, semFin) {
        return Http.get('reportes/rptAll/' + dptoId+'_'+semIni+'_'+semFin);
    };
...
angular.module("RDash").controller('reportesCtrl', function($scope,  $location, Reporte, Utilidad) {
    ...
    $scope.generarReporte = function() {
        ...
        $scope.urlRpt = 'api/reportes/rptAll/'+deptoId+'_'+$scope.filtro.semIni+'_'+$scope.filtro.semFin;
        $scope.urlRptCrr = 'api/reportes/rptCerr/'+$scope.filtro.semIni+'_'+$scope.filtro.semFin;
        $scope.urlRptPln = 'api/reportes/rptPlnd/'+$scope.filtro.semIni+'_'+$scope.filtro.semFin;
...
angular.module("RDash").controller('estimacionCtrl', function($scope, $location, Estimacion, Utilidad, Tarea) {
    ...
    $scope.guardarEstimacion = function() {
        $scope.promise = Tarea.getEstimaciones($scope.estimacion.TareaId,$scope.estimacion.semana).then(function(tareas){
